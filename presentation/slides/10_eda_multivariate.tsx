      ...
      <div className="grid grid-cols-2 gap-8 flex-1 min-h-0">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex-1 rounded-xl bg-slate-800/40 border border-dashed border-slate-700 flex flex-col items-center justify-center gap-2">
            {/* IMAGE: 10_pca_colored.png — 700×400 — PCA des features, colorée par prix */}
            <span className="text-4xl opacity-30">🔵</span>
            <p className="text-slate-500 text-sm text-center px-6">
              PCA des features numériques, colorée par prix
              <br />
              <span className="text-xs font-mono text-slate-600">→ placer: public/images/10_pca_colored.png</span>
            </p>
          </div>
